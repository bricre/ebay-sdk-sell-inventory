...
class InventoryItem extends AbstractModel
{
     ...
     * <strong>getInventoryItem</strong> and <strong>getInventoryItems</strong> calls
     * if a condition description was provided for a used inventory
     * item.<br/><br/><strong>Max Length</strong>: 1000.
     *
     * @var string
     */
     ...
     * <strong>getInventoryItem</strong> and <strong>getInventoryItems</strong> calls
     * if package type, package weight, and/or package dimensions are specified for an
     * inventory item.<br/><br/>See the <a
