 ...
 * items that will be available for purchase through one or more published offers.
 */
class ShipToLocationAvailabilityWithAll extends AbstractModel
{
    /**
     * This container is used to specify the quantity of the inventory item that is
     * available for purchase, allocated by the offer types.
     *
     * @var \Ebay\Sell\Inventory\Model\FormatAllocation
     */
    public $allocationByFormat = null;
     ...
     * the available quantity is set for one or more inventory locations.
     *
