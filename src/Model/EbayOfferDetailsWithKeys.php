 ...
 * of the <strong>createOffer</strong> and <strong>bulkCreateOffer</strong>
 * methods.
 */
class EbayOfferDetailsWithKeys extends AbstractModel
{
    /**
     * This integer value sets the quantity of the inventory item (specified by the
     * <strong>sku</strong> value) that will be available for purchase by buyers
     * shopping on the eBay site specified in the <strong>marketplaceId</strong> field.
     * Quantity must be set to <code>1</code> or more in order for the inventory item
     * to be purchasable, but this field is not necessarily required, even for
     * published offers, if the general quantity of the inventory item has already been
     * set in the inventory item record.<br/><br/> For auction listings, this value
     * must be <code>1</code>.
     *
     * @var int
     */
     ...
     * be required before publishing the offer. Sellers can use the <a
     ...
     * eBay listing. This container consists of the <strong>charityId</strong> field to
     * identify the charitable organization, and the
     * <strong>donationPercentage</strong> field that indicates the percentage of the
     * sales proceeds that will be donated to the charitable organization for each
     * sale. Both fields in this container are conditionally required for charitable
     * listings.
     *
     ...
     * <br/><br/>Supported values are <code>FIXED_PRICE</code> and
     * <code>AUCTION</code>. For implementation help, refer to <a
     ...
     * create a private listing. <br><br> Sellers may want to use this option when they
     ...
     * identifier is provided in
     * <strong>createOrReplaceInventoryItem</strong>.<br/><br/>
     ...
     * span tags.</span><br><br><strong>Max length</strong>: 500000 (which includes
     * HTML markup/tags).
     *
     * @var string
     */
     ...
     * marketplace, category, or product.<br/><br/>It is required that the seller be
     * opted into Business Policies before being able to create live eBay listings
     * through the Inventory API. Sellers can opt-in to Business Policies through My
     * eBay or by using the Account API's <strong>optInToProgram</strong> call.
     * Payment, return, and fulfillment listing policies may be created/managed in My
     * eBay or by using the listing policy calls of the sell <strong>Account
     * API</strong>. The sell <strong>Account API</strong> can also be used to create
     * and manage custom policies. For more information, see the sell <a
     * href="/api-docs/sell/account/overview.html">Account API</a>.
     *
     ...
     * seller will have enought time to publish the listing with the
     * <strong>publishOffer</strong> method.<br><br> This field is optional. If this
     ...
     * offer will be made available. See <strong>MarketplaceEnum</strong> for the list
     * of supported enumeration values. This field is required. For implementation
     * help, refer to <a
     ...
     * not initially required upon first creating an offer, but the price of the offer
     * will become required before an offer can be published.
     *
     ...
     * specified for this field. So, if this field's value is <code>5</code>, each
     * buyer may purchase between one to five of these products, and the purchases can
     * occur in one multiple-quantity purchase, or over multiple transactions. If a
     ...
     * to the eBay store categories, as shown below:<br>
     * <pre><code>"storeCategoryNames": [<br/> "/Fashion/Men/Shirts", <br/>
     * "/Fashion/Men/Accessories" ], </pre></code>.
     *
     * @var string[]
     */
     ...
     * <strong>Account API</strong>.<br/><br/>See the <a
